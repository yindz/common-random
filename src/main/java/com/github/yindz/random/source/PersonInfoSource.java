...
import com.github.yindz.random.constant.CreditCardType;
import com.github.yindz.random.constant.Province;
import com.github.yindz.random.constant.RandomConstant;
import com.github.yindz.random.entity.IdPrefix;
import com.github.yindz.random.util.PinyinUtils;
...
public class PersonInfoSource {
    ...
    /**
     * 随机信用卡号码
     * <p>注意: 此方法已移动到 {@link com.github.yindz.random.source.FinancialSource#randomCreditCardNo(CreditCardType) FinancialSource.randomCreditCardNo}</p>
     *
     * @param type 信用卡类型
     * @return 随机信用卡号码
     */
